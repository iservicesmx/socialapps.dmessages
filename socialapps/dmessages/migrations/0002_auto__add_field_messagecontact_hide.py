...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageContact.hide'
        db.add_column('dmessages_messagecontact', 'hide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageContact.hide'
        db.delete_column('dmessages_messagecontact', 'hide')
