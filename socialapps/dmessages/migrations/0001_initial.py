...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dmessages_messagecontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='msgs_from_users', to=orm['auth.User'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='msgs_to_users', to=orm['auth.User'])),
            ('latest_message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dmessages.Message'])),
        ))
        db.send_create_signal('dmessages', ['MessageContact'])

        # Adding unique constraint on 'MessageContact', fields ['from_user', 'to_user']
        db.create_unique('dmessages_messagecontact', ['from_user_id', 'to_user_id'])

        # Adding model 'MessageRecipient'
        db.create_table('dmessages_messagerecipient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dmessages.Message'])),
        ...
        db.send_create_signal('dmessages', ['MessageRecipient'])

        # Adding model 'Message'
        db.create_table('dmessages_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dmessages', ['Message'])


    def backwards(self, orm):
        # Removing unique constraint on 'MessageContact', fields ['from_user', 'to_user']
        db.delete_unique('dmessages_messagecontact', ['from_user_id', 'to_user_id'])

        # Deleting model 'MessageContact'
        db.delete_table('dmessages_messagecontact')

        # Deleting model 'MessageRecipient'
        db.delete_table('dmessages_messagerecipient')

        # Deleting model 'Message'
        db.delete_table('dmessages_message')
    ...
    models = {
        ...
        'dmessages.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipients': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'received_messages'", 'symmetrical': 'False', 'through': "orm['dmessages.MessageRecipient']", 'to': "orm['auth.User']"}),
        ...
        'dmessages.messagecontact': {
            'Meta': {'ordering': "['latest_message']", 'unique_together': "(('from_user', 'to_user'),)", 'object_name': 'MessageContact'},
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'msgs_from_users'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dmessages.Message']"}),
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'msgs_to_users'", 'to': "orm['auth.User']"})
        },
        'dmessages.messagerecipient': {
            'Meta': {'object_name': 'MessageRecipient'},
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dmessages.Message']"}),
