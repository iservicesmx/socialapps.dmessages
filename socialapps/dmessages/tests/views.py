...
class MessagesViewsTests(TestCase):
    ...
    def test_compose(self):
        ...
        # Login is required.
        self._test_login('socialapps_messages_compose')

        # Sign in
        client = self.client.login(username='john', password='blowfish')
        response = self.client.get(reverse('socialapps_messages_compose'))

        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response,
                                'messages/message_form.html')
    ...
    def test_compose_post(self):
        ...
        response = self.client.post(reverse('socialapps_messages_compose'),
                                    data=valid_data)

        self.assertRedirects(response,
                             reverse('socialapps_messages_detail',
                                     kwargs={'username': 'john'}))

        # Check for a requested redirect
        valid_data['next'] = reverse('socialapps_messages_compose')
        response = self.client.post(reverse('socialapps_messages_compose'),
                                    data=valid_data)
        self.assertRedirects(response,
                             valid_data['next'])
    ...
    def test_compose_recipients(self):
        ...
        response = self.client.get(reverse('socialapps_messages_compose_to',
    ...
    def test_message_detail(self):
        ...
        self._test_login('socialapps_messages_detail',
                          kwargs={'message_id': 2})

        # Sign in
        client = self.client.login(username='jane', password='blowfish')
        response = self.client.get(reverse('socialapps_messages_detail',
                                   kwargs={'message_id': 1}))
    ...
    def test_valid_message_remove(self):
        ...
        response = self.client.post(reverse('socialapps_messages_remove'))
        self.assertEqual(response.status_code, 302)
        ...
        response = self.client.get(reverse('socialapps_messages_remove'))
        ...
        response = self.client.post(reverse('socialapps_messages_remove'),
                                    data={'message_pks': '1'})
        self.assertRedirects(response,
                             reverse('socialapps_messages_list'))
        ...
        response = self.client.post(reverse('socialapps_messages_remove'),
                                    data={'message_pks': '1',
                                          'next': reverse('socialapps_messages_list')})
        self.assertRedirects(response,
                             reverse('socialapps_messages_list'))
        jane = User.objects.get(username='jane')
    ...
    def test_message_unremove(self):
        ...
        response = self.client.post(reverse('socialapps_messages_unremove'),
                                    data={'message_pks': [1,]})
    ...
    def test_message_list(self):
        ...
        self._test_login("socialapps_messages_list")

        client = self.client.login(username="john", password="blowfish")
        response = self.client.get(reverse("socialapps_messages_list"))
        self.assertEqual(response.status_code, 200)
